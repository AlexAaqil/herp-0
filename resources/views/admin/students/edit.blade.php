<x-admin-layout class="Users">
    ...
    <div class="custom_form">
        ...
        <form action="{{ route('students.update', $student->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="input_group">
                    ...
                    <select name="class_section_id" id="class_section_id">
                        ...
                        @foreach ($class_sections as $class_section)
                            <option value="1"  {{ old('class_section_id', $student->class_section_id) == $class_section->id ? 'selected' : '' }}>{{ $class_section->title }}</option>
                        @endforeach
                    </select>
            ...
            <div class="row_input_group_3">
                ...
                <div class="input_group">
                    ...
                    <div class="custom_radio_buttons">
                        <label>
                            <input class="option_radio" type="radio" name="graduation_status" id="yes" value="1" {{ old('graduation_status', $student->graduation_status) == '1' ? 'checked' : '' }}>
                            <span>Graduated</span>
                        </label>

                        <label>
                            <input class="option_radio" type="radio" name="graduation_status" id="no" value="0" {{ old('graduation_status', $student->graduation_status) == '0' ? 'checked' : '' }}>
                            <span>Not</span>
                        </label>
                    </div>
                ...
                <div class="input_group">
                    ...
                    <input type="date" id="graduation_date" name="graduation_date" value="{{ old('graduation_date', $student->graduation_date) }}">
            ...
            <div class="row_input_group">
                ...
                <div class="input_group">
                    ...
                    <input type="password" name="password" id="password" placeholder="Leave blank for default st123456">
            ...
            <div class="buttons">
                ...
                <button type="button" class="delete_btn" onclick="deleteItem({{ $student->id }}, 'student');" form="deleteForm_{{ $student->id }}">
        ...
        <form id="deleteForm_{{ $student->id }}" action="{{ route('students.destroy', $student->id) }}" method="post" style="display: none;">
            @csrf
            @method('DELETE')
        </form>
    </div>
