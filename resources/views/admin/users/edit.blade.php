        ...
        <form action="{{ route('users.update', ['user' => $user->id]) }}" method="post">
            ...
            <div class="row_input_group">
                <div class="input_group">
                    ...
                    <select name="user_level" id="user_level" required>
                        <option value="" disabled {{ empty($selectedUserLevel) ? 'selected' : '' }}>Select User Level</option>
                ...
                <div class="input_group">
                    ...
                    <input type="text" name="emp_code" id="emp_code" placeholder="Employee Code" value={{ old('emp_code',$user->emp_code) }}>
            ...
            <div class="row_input_group">
                ...
                <div class="input_group">
                    ...
                    <input type="text" name="phone_main" id="phone_main" placeholder="Phone Number" value="{{ old('phone_main',$user->phone_main) }}">
            ...
            <div class="row_input_group">
                <div class="input_group">
                    ...
                    <input type="text" name="password" id="password" placeholder="Leave as blank for default password (hsms1234)">
                    <span class="inline_alert">{{ $errors->first('password') }}</span>
                </div>
    
                <div class="input_group">
                    <label for="password_confirmation">Confirm Password</label>
                    <input type="text" name="password_confirmation" id="password_confirmation" placeholder="Leave as blank for default password">
